...
public class RotaItinerario {
	...
	public RotaItinerario(int rotaItinerarioId, int rotaId,int itinerarioId, int Ordem) {
		
		RotaItinerarioId = rotaItinerarioId;
		this.rotaitinerario_rotaId = rotaId;
		this.rotaitinerario_itinerarioId = itinerarioId;
		this.rotaitinerarioOrdem = Ordem;
	}
