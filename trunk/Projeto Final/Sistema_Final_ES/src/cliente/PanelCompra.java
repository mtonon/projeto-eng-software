...
public class PanelCompra extends JFrame implements MouseListener {
    ...
    private void initComponents() {
        ...
        this.setExtendedState(PanelCompra.MAXIMIZED_BOTH); //abrir tela maximizada
    ...
    public static void main(String[] args) {
        PanelCompra esse = new PanelCompra();
